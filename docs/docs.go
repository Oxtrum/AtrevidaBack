        ...
        "/auth/deactivate": {
            "patch": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Conflicto: ya existe un usuario activo con ese nombre o se intenta desactivar al unico admin_sys activo",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.registrarUsuarioRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/usuarios/local": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Usuario y local a asignar",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.actualizarUsuarioLocalRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Error de validacion: body invalido, username requerido o local_id invalido",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
                    ...
                    "403": {
                        "description": "Usuario no autorizado o solo un administrador puede asignarse un local",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
                    "404": {
                        "description": "Usuario o local no encontrado",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handlers.comboImagenResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handlers.comboImagenUploadResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/bd/pagos/resumen": {
            "get": {
                ...
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handlers.pagoResumenResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "400": {
                        "description": "Error de validacion: fecha_desde requerido, fecha_hasta requerido, fecha con formato invalido o rango invalido",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "example": "2026-05-24",
                        "description": "Fecha a consultar YYYY-MM-DD; si es domingo los indicadores diarios son cero y la semana termina el sabado anterior",
                        "name": "fecha",
                        "in": "query",
                        "required": true
                    },
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Error de validacion: fecha requerida o formato invalido",
                        "schema": {
                            "$ref": "#/definitions/utils.APIResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "handlers.actualizarPagoRequest": {
            ...
            "properties": {
                ...
                "tipo_pago": {
                    "description": "Nuevo tipo de pago (opcional): efectivo o qr.",
                    "type": "string",
                    "example": "qr"
                },
                "total_final": {
        ...
        "handlers.actualizarUsuarioLocalRequest": {
            "type": "object",
            "required": [
                "local_id",
                "username"
            ...
            "properties": {
                "local_id": {
                    "description": "ID del local activo a asignar al usuario.",
                    "type": "integer",
                    "example": 1
                },
                "username": {
                    "description": "Nombre de usuario a modificar.",
                    "type": "string",
                    "example": "operador"
                }
            }
        ...
        "handlers.authRequest": {
            ...
            "properties": {
                "password": {
                    "description": "Password en texto plano enviada por el cliente.",
                    "type": "string",
                    "example": "Secreto123"
                },
                "username": {
        ...
        "handlers.comboImagenResponse": {
            "type": "object",
            "properties": {
                "imagen_url": {
                    "description": "URL publica de la portada del combo.",
                    "type": "string",
                    "example": "https://xxx.supabase.co/storage/v1/object/public/paquetes/combos/12"
                }
            }
        },
        "handlers.comboImagenUploadResponse": {
            "type": "object",
            "properties": {
                "path": {
                ...
                "upload_url": {
                    ...
                    "type": "string",
                    "example": "https://xxx.supabase.co/storage/v1/object/upload/sign/paquetes/combos/12?token=eyJ"
                }
            }
        },
        ...
        "handlers.crearPagoRequest": {
            ...
            "properties": {
                ...
                "tipo_pago": {
                    "description": "Tipo de pago utilizado: efectivo o qr.",
                    "type": "string",
                    "example": "efectivo"
                },
                "total_final": {
        ...
        "handlers.crearPlanRequest": {
            ...
            "properties": {
                ...
                "pago_codigo": {
                    "description": "Codigo del pago de caja a aplicar a la cuota (UNICO); marca la cuota PAGADO.",
                    "type": "string",
                    "example": "PAG-000123"
                },
                "servicios": {
        ...
        "handlers.crearReservaPGRequest": {
            ...
            "properties": {
                ...
                "estado": {
                    "description": "Estado inicial: PENDIENTE (default), AGENDADO",
                    "type": "string",
                    "example": "PENDIENTE"
                },
                "fecha": {
        ...
        "handlers.pagoResumenResponse": {
            "type": "object",
            "properties": {
                "detalle_reportes": {
                    "description": "Reportes por local; vacio cuando se filtra por un local",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.PagoResumenReporte"
                    }
                },
                "filtros": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/services.PagoResumenFiltros"
                        }
                    ]
                },
                "reporte": {
                    "description": "Reporte general o reporte del local filtrado",
                    "allOf": [
                        {
                            "$ref": "#/definitions/services.PagoResumenReporte"
                        }
        ...
        "handlers.registrarUsuarioRequest": {
            ...
            "properties": {
                ...
                "rol_codigo": {
                    "description": "Codigo del rol a asignar al usuario.",
                    "type": "string",
                    "example": "gerencia"
                },
                "username": {
        ...
        "handlers.reservaNotificacionListResponse": {
            ...
            "properties": {
                "reservas": {
                    "description": "Notificaciones pendientes con los datos minimos que muestra la campanita.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.ReservaNotificacion"
                    }
                },
                "total": {
        ...
        "models.ComboCatalogoPG": {
            ...
            "properties": {
                ...
                "imagen_url": {
                    "description": "URL publica de la portada derivada del path; nil si el combo no tiene imagen.",
                    "type": "string",
                    "example": "https://xxx.supabase.co/storage/v1/object/public/paquetes/combos/12"
                },
                "locales": {
        ...
        "models.ReservaItem": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "ID de la reserva; permite abrir el detalle desde el calendario.",
                    "type": "integer",
                    "example": 100
                },
                "local": {
                    "description": "Local, fecha y horario para reconstruir la reserva en el detalle.",
                    "type": "string",
                    "example": "SAN MARTIN"
                },
                "notificado": {
                ...
                "plan_id": {
                    "description": "ID del plan asociado, si la reserva consume un paquete.",
                    "type": "integer",
                    "example": 5
                },
                "reserva_hora_hasta": {
        ...
        "services.PagoResumenFiltros": {
            ...
            "properties": {
                ...
                "local": {
                    "description": "Local filtrado; vacio cuando el reporte es general.",
                    "type": "string",
                    "example": "SAN MARTIN"
                }
            }
        },
        "services.PagoResumenReporte": {
            "type": "object",
            "properties": {
                "cantidad_pagos": {
                    "description": "Cantidad de pagos considerados.",
                    "type": "integer",
                    "example": 32
                },
                "cantidad_servicios_vendidos": {
                    "description": "Cantidad total de servicios vendidos segun el detalle de pagos.",
                    "type": "integer",
                    "example": 45
                },
                "descuentos": {
                    "description": "Descuentos acumulados en el periodo.",
                    "type": "number",
                    "example": 143
                },
                "local": {
                    "description": "Nombre del local del reporte; vacio para reporte general.",
                    "type": "string",
                    "example": "SAN MARTIN"
                },
                "servicio_mas_comprado": {
                    "description": "Servicio con mayor cantidad vendida.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/services.PagoResumenServicio"
                        }
                    ]
                },
                "servicio_mas_dinero_genera": {
                    "description": "Servicio con mayor monto generado.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/services.PagoResumenServicio"
                        }
                ...
                "subtotal": {
                    "description": "Subtotal acumulado antes de descuentos.",
                    "type": "number",
                    "example": 85000
                },
                "ticket_promedio": {
                    "description": "Promedio de venta por pago.",
                    "type": "number",
                    "example": 2651.78
                },
                "tipo_reporte": {
                    "description": "Tipo de reporte: general o Local: \u003cnombre local\u003e.",
                    "type": "string",
                    "example": "general"
                },
                "total_periodo": {
                    "description": "Total final vendido en el periodo.",
                    "type": "number",
                    "example": 84857
                },
                "ventas_por_tipo_pago": {
                    "description": "Totales agrupados por tipo de pago.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.PagoResumenTipoPago"
                    }
                }
            }
        },
        "services.PagoResumenServicio": {
            "type": "object",
            "properties": {
                "cantidad": {
                    "description": "Cantidad total vendida del servicio.",
                    "type": "integer",
                    "example": 12
                },
                "monto_total": {
                    "description": "Monto total generado por el servicio.",
                    "type": "number",
                    "example": 1200
                },
                "servicio": {
                    "description": "Nombre del servicio cobrado.",
                    "type": "string",
                    "example": "Limpieza facial"
                }
            }
        },
        "services.PagoResumenTipoPago": {
            "type": "object",
            "properties": {
                "cantidad_pagos": {
                    "description": "Cantidad de pagos registrados con este tipo.",
                    "type": "integer",
                    "example": 8
                },
                "tipo_pago": {
                ...
                "total": {
                    "description": "Total final acumulado para este tipo de pago.",
                    "type": "number",
                    "example": 2500
                }
            }
        },
        "services.ReservaNotificacion": {
            "type": "object",
            "properties": {
                "cliente": {
                    "type": "string",
